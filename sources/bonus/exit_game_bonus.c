...
void	free_structure_of_game(t_game *game)
{
	...
	if (game->img_collectible_stardown)
		mlx_destroy_image(game->mlx, game->img_collectible_stardown);
	if (game->img_collectible_starup)
		mlx_destroy_image(game->mlx, game->img_collectible_starup);
	if (game->img_player)
